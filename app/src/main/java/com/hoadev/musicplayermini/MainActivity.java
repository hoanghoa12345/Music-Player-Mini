package com.hoadev.musicplayermini;
...
import com.hoadev.musicplayermini.adapters.AlbumsAdapter;
import com.hoadev.musicplayermini.adapters.ArtistsAdapter;
import com.hoadev.musicplayermini.adapters.ColorsAdapter;
import com.hoadev.musicplayermini.adapters.SongsAdapter;
import com.hoadev.musicplayermini.loaders.ArtistProvider;
import com.hoadev.musicplayermini.models.Album;
import com.hoadev.musicplayermini.models.Artist;
import com.hoadev.musicplayermini.models.Song;
import com.hoadev.musicplayermini.playback.EqualizerUtils;
import com.hoadev.musicplayermini.playback.MusicNotificationManager;
import com.hoadev.musicplayermini.playback.MusicService;
import com.hoadev.musicplayermini.playback.PlaybackInfoListener;
import com.hoadev.musicplayermini.playback.PlayerAdapter;

import com.hoadev.musicplayermini.slidinguppanel.SlidingUpPanelLayout;
...
public class MainActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<List<Artist>>, SongsAdapter.SongSelectedListener, ColorsAdapter.AccentChangedListener, AlbumsAdapter.AlbumSelectedListener, ArtistsAdapter.ArtistSelectedListener {
    ...
    public void openGitPage(View v) {
        try {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/hoanghoa12345/Music-Player-Mini")));
    ...
    public class PlaybackListener extends PlaybackInfoListener {
        ...
        public void onStateChanged(@State int state) {
            ...
            updatePlayingStatus();
            if (mPlayerAdapter.getState() != PlaybackInfoListener.State.RESUMED && mPlayerAdapter.getState() != State.PAUSED) {
